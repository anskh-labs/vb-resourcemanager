...
Namespace VBNetCore.Mvvm.ViewModels
    Public MustInherit Class HasPopupViewModel
        ...
        Public Sub HidePopup() Implements IPopupable.HidePopup
            ...
            If CurrentPopup IsNot Nothing Then
                RemoveHandler CurrentPopup.CloseHandler, AddressOf Me.PopupViewModel_CloseHandler
        ...
        Public Function ShowPoup(ByVal popupViewModel As PopupViewModel) As PopupViewModel Implements IPopupable.ShowPoup
            AddHandler popupViewModel.CloseHandler, AddressOf Me.PopupViewModel_CloseHandler
            ...
            While IsPopupVisible
                ...
                Call Dispatcher.CurrentDispatcher.Invoke(DispatcherPriority.Background, New ThreadStart(Sub() Thread.Sleep(20)))
            End While
